...
<div style="width:850px; margin:0px auto;">
	<div id="age0" class="hovery" style="cursor:pointer; float:left; position:relative; padding:5px;" onclick="refreshInjuryData(0, 0);"><img alt="a child" class="shadowy" style="width:155px; height:288px;" src="age06.png"></img><div style="position:absolute; bottom:10px; right:10px; background-color:green;">0-6 Months<img alt="arrow" style="padding:2px;" src="arrow.png"></img></div></div>
	<div id="age1" class="hovery" style="cursor:pointer; float:left; position:relative; padding:5px;" onclick="refreshInjuryData(0, 1);"><img alt="a child" class="shadowy" style="width:155px; height:288px;" src="age612.png"></img><div style="position:absolute; bottom:10px; right:10px; background-color:green;">6-12 Months<img alt="arrow" style="padding:2px;" src="arrow.png"></img></div></div>
	<div id="age2" class="hovery" style="cursor:pointer; float:left; position:relative; padding:5px;" onclick="refreshInjuryData(0, 2);"><img alt="a child" class="shadowy" style="width:155px; height:288px;" src="age13.png"></img><div style="position:absolute; bottom:10px; right:10px; background-color:green;">1-3 Years<img alt="arrow" style="padding:2px;" src="arrow.png"></img></div></div>
	<div id="age3" class="hovery" style="cursor:pointer; float:left; position:relative; padding:5px;" onclick="refreshInjuryData(0, 3);"><img alt="a child" class="shadowy" style="width:155px; height:288px;" src="age35.png"></img><div style="position:absolute; bottom:10px; right:10px; background-color:green;">3-5 Years<img  alt="arrow"style="padding:2px;" src="arrow.png"></img></div></div>
	<div id="age4" class="hovery" style="cursor:pointer; float:left; position:relative; padding:5px;" onclick="refreshInjuryData(1, 4);"><img alt="a child" class="shadowy" style="width:155px; height:288px;" src="age5p.png"></img><div style="position:absolute; bottom:10px; right:10px; background-color:green;">5+ Years<img alt="arrow" style="padding:2px;" src="arrow.png"></img></div></div>
</div>
<div style="clear:both;"></div>

<div style="width:850px; margin:0px auto;">
	<div id="room0" class="hovery" style="cursor:pointer; float:left; position:relative; padding:5px;" onclick="refreshTips(0);"><img alt="outside" class="shadowy" style="width:155px; height:90px;" src="outdoors.png"></img><div style="position:absolute; bottom:10px; right:10px; background-color:green;">Outdoors<img alt="arrow" style="padding:2px;" src="arrow.png"></img></div><div style="position:absolute; background-color:red; top:10px; left:10px;" id="percent3"></div></div>
	<div id="room1" class="hovery" style="cursor:pointer; float:left; position:relative; padding:5px;" onclick="refreshTips(1);"><img alt="kitchen" class="shadowy" style="width:155px; height:90px;" src="kitchen.png"></img><div style="position:absolute; bottom:10px; right:10px; background-color:green;">Kitchen<img alt="arrow" style="padding:2px;" src="arrow.png"></img></div><div style="position:absolute; background-color:red; top:10px; left:10px;" id="percent2"></div></div>
	<div id="room2" class="hovery" style="cursor:pointer; float:left; position:relative; padding:5px;" onclick="refreshTips(2);"><img alt="bedroom" class="shadowy" style="width:155px; height:90px;" src="bedroom.png"></img><div style="position:absolute; bottom:10px; right:10px; background-color:green;">Bedroom<img alt="arrow" style="padding:2px;" src="arrow.png"></img></div><div style="position:absolute; background-color:red; top:10px; left:10px;" id="percent0"></div></div>
	<div id="room3" class="hovery" style="cursor:pointer; float:left; position:relative; padding:5px;" onclick="refreshTips(3);"><img alt="bathroom" class="shadowy" style="width:155px; height:90px;" src="bathroom.png"></img><div style="position:absolute; bottom:10px; right:10px; background-color:green;">Bathroom<img alt="arrow" style="padding:2px;" src="arrow.png"></img></div><div style="position:absolute; background-color:red; top:10px; left:10px;" id="percent1"></div></div>
	<div id="room4" class="hovery" style="cursor:pointer; float:left; position:relative; padding:5px;" onclick="refreshTips(4);"><img alt="livingroom" class="shadowy" style="width:155px; height:90px;" src="livingroom.png"></img><div style="position:absolute; bottom:10px; right:10px; background-color:green;">Living room<img alt="arrow" style="padding:2px;" src="arrow.png"></img></div><div style="position:absolute; background-color:red; top:10px; left:10px;" id="percent4"></div></div>
</div>
<div style="clear:both;"></div>
<div style="width:850px; margin:0px auto; background-color:eee;">
